...
<a name='BLCKTeam'></a>BLCK Team [@Azegele](https://twitter.com/bradleyazegele) & [@thestephse](https://twitter.com/thestephse)
...
-Return on Investment(ROI) cost of a gateway can made through [Proof of Coverage (PoC)](https://docs.helium.com/blockchain/proof-of-coverage) rewards and Data Credits(DC) consumption. -[LoRaWAN Network Servers (LNS)](https://console.helium.com/) , managed by [Helium Foundation](https://www.helium.foundation/) can be integrated in minutes.
...
> **IF** the tracker can _hear_ a beacon and this beacon is attached to a lion's collar **THEN** the lion must be within a radius around the tracker.
